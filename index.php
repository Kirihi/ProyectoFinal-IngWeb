...
<div class="w3-top">
  <div class="w3-bar w3-purple w3-card w3-left-align w3-large">
    ...
    <a href="equipos/mostrar_equipo.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Equipos</a>
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large">
    ...
    <a href="sesion/login.html" class="w3-bar-item w3-button w3-padding-large">Login</a>
  </div>
</div>

<!-- Header -->
<header class="w3-container w3-purple w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">Copa Mundial de Fútbol</h1>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-twothird">
      ...
      <h5 class="w3-padding-32">A través de este sitio web podrá ver diferentes detalles del Mundial de la FIFA Catar 2022</h5>
